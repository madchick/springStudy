...
public class Week02Application {
    ...
    public CommandLineRunner demo(CourseRepository repository, CourseService courseService) {
        return (args) -> {
            Course course = new Course("웹개발의 봄 스프링","남병관");
...
// 데이터 하나 조회하기
            ...
            // Course new_course = new Course("웹개발의 봄, Spring", "오광섭");
            CourseRequestDto requestDto = new CourseRequestDto("웹개발의 봄, Spring", "오광섭");
